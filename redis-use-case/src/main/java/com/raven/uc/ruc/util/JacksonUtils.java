...
public class JacksonUtils {
    ...
    static {
        ...
        //所有的日期格式都统一为以下的样式，即yyyy-MM-dd HH:mm:ss.SSS
    ...
    public static String obj2json(Object obj) {
        try {
            ...
            log.error("JacksonUtils.obj2json error, cause by: ", e);
            return null;
        }
    }
    ...
    public static <T> Map<String, Object> json2map(String jsonString){
        try {
            ...
            log.error("JacksonUtils.json2map error, data: {}, cause by: ", jsonString, e);
            return null;
        }
